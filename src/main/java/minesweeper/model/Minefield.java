...
public class Minefield {
    ...
    public int gridEasyWidth = 5;
    public int gridEasyHeight = 5;
    public int gridNormalHeight = 10;
    public int gridNormalWidth = 10;
    public int gridHardWidth = 16;
    public int gridHardHeight = 20;

    public int minefieldWidth  = 10;           // starts at normal , default values
    public int minefieldHeight = 10;           // should change when choicebox changes

    // grid amount of mines
    public int gridEasyNumMines = 5;
    public int gridNormalNumMines = 50;
    public int gridHardNumMines = 190;

    int numMinesatStart;
    public int numMinesLeft   ;            // number mines left = number mines at start
    ...
    // set flag or unflag
    public boolean mark(Cell cell) {       // REG'd
